...
<head>
    <?php partial('head', [
        ...
        'metaDescription' => 'AI application form answers UK. Generate tailored answers to job application questions using AI. Paste questions, get answers based on your CV and the role.',
