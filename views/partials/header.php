                ...
                <?php if (isLoggedIn()): ?>
                    ...
                    <div class="relative group">
                        ...
                        <div role="menu" class="absolute right-0 top-full hidden min-w-[12rem] rounded-lg border border-gray-200 bg-white py-2 shadow-lg group-hover:block">
                            <a href="/resources/" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 focus:outline-none focus:bg-gray-50">All Resources</a>
                ...
                <?php if (isLoggedIn()): ?>
                    ...
                    <div class="px-4 py-2">
                        ...
                        <div id="mobile-resources-menu" class="hidden mt-2 pl-4 space-y-1">
                            <a href="/resources/" class="block text-gray-600 hover:text-blue-600 px-4 py-2 rounded-md text-sm">All Resources</a>
