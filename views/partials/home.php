...
<section class="browser-ai-hero-bg relative overflow-hidden w-full py-14 sm:py-18 lg:py-22">
    <div class="absolute inset-0 z-0">
        <picture>
            ...
            <img src="/static/images/home/AI-in-the-browseer.png" alt="AI-powered CV builder running in your browser" class="w-full h-full object-cover object-center" width="800" height="533" aria-hidden="true" fetchpriority="high">
        </picture>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center mb-12">
            ...
            <div class="mt-8 mb-12 pt-8 border-t border-indigo-200 flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <a href="/blog/job-search/" class="inline-flex items-center justify-center rounded-lg border-2 border-indigo-600 px-8 py-4 text-base font-semibold text-indigo-600 hover:bg-indigo-50 transition-colors">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
