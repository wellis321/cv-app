                ...
                <div id="jobs-applications-table" class="hidden jobs-table-wrap" style="max-height: calc(100vh - 300px); overflow-x: scroll; overflow-y: auto;">
                    <table class="min-w-full divide-y divide-gray-200 jobs-table">
                        <thead class="bg-gray-50 sticky top-0 z-10">
                            <tr>
                                <th data-column="company" data-sortable="company" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Company <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
                                <th data-column="job_title" data-sortable="job_title" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Job Title <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
                                <th data-column="status" data-sortable="status" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Status <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
                                <th data-column="priority" data-sortable="priority" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Priority <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
                                <th data-column="closing_date" data-sortable="closing_date" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Closing Date <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
                                <th data-column="location" data-sortable="location" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Location <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
                                <th data-column="salary" data-sortable="salary" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Salary <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
                                <th data-column="date_added" data-sortable="date_added" class="jobs-sortable-header px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 cursor-pointer hover:bg-gray-100 select-none" role="columnheader" aria-sort="none" title="Click to sort">Date Added <span class="jobs-sort-indicator ml-1 inline-block w-4"></span></th>
