        ...
        <form method="POST" data-section-form data-form-type="<?php echo $editingMembership ? 'update' : 'create'; ?>">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" maxlength="5000" data-markdown class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"><?php echo $editingMembership ? e($editingMembership['description'] ?? '') : ''; ?></textarea>
                </div>
            </div>
