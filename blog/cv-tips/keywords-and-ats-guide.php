...
$canonicalUrl = APP_URL . '/blog/cv-tips/keywords-and-ats-guide.php';
$breadcrumbs = [
...
<head>
    <?php partial('head', [
        ...
        'metaImage' => 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&h=630&fit=crop',
        'metaKeywords' => 'CV keywords, ATS optimisation, applicant tracking system, CV screening, keywords for CV, UK job applications, ATS friendly CV, CV optimisation',
...
<body class="bg-slate-50">
    ...
    <article class="relative isolate overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-white px-6 pt-16 pb-24 sm:px-6 sm:pt-24 sm:pb-32 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <nav aria-label="Page sections" class="mt-8 rounded-xl border border-slate-200 bg-white/80 p-4 text-left">
                <p class="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-3">Jump to a section</p>
                <ul class="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 text-sm">
                    <li><a href="#what-is-ats" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">What is ATS?</a></li>
                    <li><a href="#how-ats-works" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">How ATS works</a></li>
                    <li><a href="#why-keywords-matter" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">Why keywords matter</a></li>
                    <li><a href="#finding-keywords" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">Finding keywords</a></li>
                    <li><a href="#optimising-your-cv" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">Optimising your CV</a></li>
                    <li><a href="#common-mistakes" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">Common mistakes</a></li>
                    <li><a href="#ats-friendly-formatting" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">ATS-friendly formatting</a></li>
                    <li><a href="#tailoring-for-each-role" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">Tailoring for each role</a></li>
                    <li><a href="#summary" class="text-slate-700 hover:text-slate-900 underline underline-offset-2">Key takeaways</a></li>
                </ul>
            </nav>
        </div>
    </article>
    ...
    <section class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16 text-base leading-relaxed text-slate-700">
        <?php foreach ($sections as $index => $section): ?>
            ...
            <?php if ($index === 4): ?>
            <?php partial('blog-cta-inline', ['heading' => 'Ready to optimise your CV for ATS?', 'subtext' => 'Build or refresh your CV with our free, ATS-friendly tool.']); ?>
            <?php endif; ?>
        <?php endforeach; ?>
    </section>
