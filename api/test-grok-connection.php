 ...
 * Tests user-provided xAI Grok API key
 */
...
// Validate API key format (Grok keys format may vary, but typically at least 20 chars)
if (strlen($apiKey) < 20) {
...
try {
    ...
    if ($httpCode === 200) {
        ...
        echo json_encode([
            'success' => true,
            'message' => 'Connection successful! Grok API key is valid.',
    ...
    error_log("Grok connection test error: " . $e->getMessage());
