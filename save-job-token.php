                    ...
                    <div class="mt-6 p-4 bg-blue-50 border-2 border-blue-300 rounded-lg">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="/help/setup/extension.php" class="inline-flex items-center justify-center rounded-lg bg-blue-600 px-6 py-2.5 text-sm font-semibold text-white shadow-md hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
